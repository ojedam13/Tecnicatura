/*
Ej 5: Realizar un juego para adivinar un numero,
para ello generar un numero aleatorio 0-100, y
luego ir pidiendo numero indicando "es mayor" o 
        ...
        do{
            ...
            if(numero < aleatorio){
                ...
                JOptionPane.showMessageDialog(null,"Digite un numero menor"); 
                 ...
                 JOptionPane.showMessageDialog(null,"Felicidades!!! Haz Acertado el Numero");
            }
            conteo++;
